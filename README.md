...
compile the mod files with mknrndll (windows or mac), or nrnivmodl (linux). Double click the mosinit.hoc file (windows) or drag and drop  
mosinit.hoc on the nrngui icon (mac), or type the command `nrngui mosinit.hoc` (linux).
